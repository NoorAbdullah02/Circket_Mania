        ...
        <div className="flex flex-col relative" ref={container}>
            ...
            <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden pt-20">
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
                    <div className="hero-badge inline-block glass-panel px-4 py-1.5 sm:px-6 sm:py-2 rounded-full mb-6 sm:mb-8 border-white/10 shadow-xl overflow-hidden group">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
                        <span className="text-brand-blue font-heading tracking-[0.3em] text-[0.65rem] sm:text-xs uppercase flex items-center gap-2">
                    ...
                    <h1 className="hero-title text-3xl sm:text-5xl md:text-8xl lg:text-[11rem] font-heading tracking-tighter text-white mb-8 sm:mb-16 uppercase leading-[0.75] flex flex-col items-center relative">
                        ...
                        <div className="flex items-center justify-center gap-2 sm:gap-4 md:gap-16 mt-3 sm:mt-6 relative title-mania-wrapper">
                            <span className="font-light tracking-[0.4em] opacity-40 text-sm sm:text-2xl md:text-6xl text-gray-300">MANIA</span>
                            <div className="relative s2-badge-container">
                                ...
                                <span className="s2-text block text-3xl sm:text-6xl md:text-[14rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-white via-brand-red to-red-900 relative z-10 drop-shadow-[0_0_60px_rgba(255,59,48,0.4)] leading-none -rotate-2 group cursor-default tracking-tighter">
                                    S2
                                </span>
