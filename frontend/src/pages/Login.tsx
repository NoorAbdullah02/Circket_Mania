                ...
                <Card className="relative bg-black/60 backdrop-blur-3xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden group">
                    ...
                    <CardHeader className="space-y-1 text-center pb-8 pt-10 border-b border-white/5 relative z-10 login-element">
                        ...
                        <div className="mb-6 flex flex-col items-center relative z-10">
                            <span className="text-brand-yellow font-heading text-lg tracking-[0.4em] drop-shadow-[0_0_15px_rgba(255,214,10,0.5)]">ICE CRICKET</span>
                            <div className="flex items-center gap-3">
                                <span className="text-white font-heading text-5xl tracking-[0.1em] uppercase leading-none">MANIA</span>
                                <div className="bg-brand-red text-black text-sm font-black px-2.5 py-1 rounded italic shadow-[0_0_20px_rgba(255,59,48,0.5)] -rotate-12 -translate-y-2">S2</div>
                            </div>
                        </div>
                    ...
                    <CardContent className="pt-8 px-8 relative z-10">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2 relative group-focus-within:neon-text-blue transition-colors duration-300 login-element">
                            ...
                            <div className="space-y-2 relative group-focus-within:neon-text-red transition-colors duration-300 login-element">
